<?php
/**
 * Allows you to include templates with your plugin so that they can be added with any theme.
 *
 * @version 1.0.0
 * @since 	0.1.0
 */
  ...
  protected $plugin_slug;
	...
	public static function get_instance() {
		...
		if( null == self::$instance ) {
			self::$instance = new Page_Templates();
		} // end if
