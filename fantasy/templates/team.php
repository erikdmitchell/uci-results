		...
		<?php if ($team=fc_get_team($team_name)) : ?>
			...
			<div class="riders">
				<?php foreach ($team->teams[0]->riders as $rider) : ?>
					<div class="rider row">
						<div class="name col-md-6"><?php echo $rider->name; ?><span class="nat"><?php echo get_country_flag($rider->nat); ?></span></div>
						<div class="place col-md-2"><?php echo $rider->place; ?></div>
						<div class="points col-md-2"><?php echo $rider->points; ?></div>
					</div>
				<?php endforeach; ?>
			</div>
		<?php else : ?>
